...
/* harmony export */   P: () => (/* binding */ picConvertor),
/* harmony export */   ug: () => (/* binding */ getUserInfo)
/* harmony export */ });
/* unused harmony export renderInfo */
    ...
    _getImg = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            imageUrl = (0,_utils_auth_js__WEBPACK_IMPORTED_MODULE_0__/* .picConvertor */ .P)(userBase64);
...
var input = '';
formImg.addEventListener('change', function (input) {
  renderImg(input);
});
...
removeImg.addEventListener('click', function () {
  ...
  (0,_utils_toast_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)('預覽頭像移除成功', 0);
});

// 2.4 上傳頭像至後臺
function uploadDecodedImg(avatar) {
  uploadImg.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var Authorization, res, responseText, code, _responseText, _code;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 4:
          res = _context2.sent;
          (0,_utils_auth_js__WEBPACK_IMPORTED_MODULE_0__/* .getUserInfo */ .ug)();
          getUserImg();
          responseText = res.data.message;
          code = res.data.code;
          (0,_utils_toast_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(responseText, code);
          _context2.next = 18;
          break;
        case 12:
          _context2.prev = 12;
          ...
          _responseText = _context2.t0.response.request.statusText;
          _code = _context2.t0.response.request.status;
          (0,_utils_toast_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(_responseText, _code);
        case 18:
        case "end":
          return _context2.stop();
      }
...
// 3.2 點擊清空密碼表單
document.querySelector('.clearPassword').addEventListener('click', function () {
  $(".password_form").bootstrapValidator("resetForm", true);
});

// 3.3 發送更新密碼請求
var pwdForm = document.querySelector('.password_form');
function updatePassword() {
  return _updatePassword.apply(this, arguments);
} // 4.1 跳轉至登入頁面
function _updatePassword() {
  _updatePassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var Authorization, pwdData, res, responseText, code, _responseText2, _code2;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          Authorization = localStorage.getItem('token');
          pwdData = serialize(pwdForm, {
            hash: true,
            empty: true
          });
          _context3.prev = 2;
        ...
        case 12:
          ...
          _responseText2 = _context3.t0.response.request.statusText;
          _code2 = _context3.t0.response.request.status;
          (0,_utils_toast_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(_responseText2, _code2);
        case 17:
        case "end":
